...
class TLOBTinyModel(nn.Module):
    ...
    def __init__(self, 
        ...
        self.attention_layers = nn.ModuleList([
            SimpleAttentionLayer(d_model, n_heads, dropout) 
...
def main():
    ...
    parser.add_argument("--model", type=str, choices=["tlob_tiny", "patchtst_small"], 
                       help="Model to export")
    parser.add_argument("--all", action="store_true", help="Export all models")
    parser.add_argument("--quant", type=str, default="int8", choices=["int8", "fp16", "none"],
    ...
    for model_name in models_to_export:
        try:
            ...
            logger.info(f"Model info: {info['total_params']:,} params, "
