#!/usr/bin/env python3
"""
Rebalancer Bot - Trades BTC and ETH with BOTH buying and selling
"""
import os
import time
import json
...
class RebalancerBot:
    def __init__(self):
        ...
        self.rebalance_threshold = 0.05  # Rebalance if >5% off target

        print("🤖 Rebalancer Bot initialized")
    ...
    def run(self):
        ...
        while True:
            try:
                ...
                print("\n🛑 Rebalancer bot stopped by user")
                break
            except Exception as e:
...
def main():
    try:
        ...
        print(f"❌ Failed to start rebalancer bot: {e}")
        return 1
