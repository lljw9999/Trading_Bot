...
class MetricsCollector:
    ...
    def histogram_observe(self, name: str, value: float, help_text: str = "", labels: Dict[str, str] = None):
        ...
        if name not in self.histograms:
            self.histograms[name] = {"help": help_text, "type": "histogram", "observations": {}}
    ...
    def generate_prometheus_format(self) -> str:
        ...
        lines.append("# HELP trading_system_uptime_seconds Total uptime of the trading system")
        lines.append("# TYPE trading_system_uptime_seconds gauge")
        lines.append(f"trading_system_uptime_seconds {time.time() - self.start_time:.2f}")
        lines.append("")
