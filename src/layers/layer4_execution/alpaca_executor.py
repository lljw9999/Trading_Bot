...
class AlpacaExecutor:
    ...
    def __init__(self):
        ...
        self.base_url = os.getenv('ALPACA_PAPER_BASE', 'https://paper-api.alpaca.markets')
    ...
    def submit_order(self, order: OrderRequest) -> OrderResponse:
        ...
        if self.dry_run or self.exec_mode == 'paper':
            ...
            try:
                ...
                response.avg_fill_price = float(alpaca_order.filled_avg_price) if alpaca_order.filled_avg_price else None
