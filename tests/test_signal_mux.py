...
class TestSignalMux(unittest.TestCase):
    ...
    async def async_test_basic_signal_processing(self):
        ...
        tick_data = TickData(
            symbol="BTC-USD", price=50000.0, volume=1.5, timestamp=time.time()
        )
    ...
    async def async_test_model_switching_detection(self):
        ...
        self.mock_router.select_model.side_effect = [
            "tlob_tiny",
            "patchtst_small",
            "patchtst_small",
        ]
    ...
    async def async_test_model_execution_fallback(self):
        ...
        tick_data = TickData(
            symbol="TEST", price=100.0, volume=1.0, timestamp=time.time()
        )
...
class TestSignalMuxIntegration(unittest.TestCase):
    ...
    def setUp(self):
        ...
        for model_id in [
            ...
            self.model_registry.register_model(
                model_id, DummyModel(model_id), {"description": f"Test {model_id}"}
            )
...
class TestDummyModel(unittest.TestCase):
    ...
    def test_dummy_model_predict(self):
        ...
        features = {"price": 50000.0, "timestamp": 1640995200.0, "volume": 1.5}
