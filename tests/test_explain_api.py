...
class TestExplainAPI(unittest.TestCase):
    ...
    def test_successful_explanation_generation(self, mock_openai_class):
        ...
        self.assertIn("Positive sentiment", result.key_factors)
    ...
    def test_key_factors_extraction(self):
        ...
        self.assertIn("Moderate positive sentiment", factors)
    ...
    def test_explanation_with_negative_sentiment(self, mock_openai_class):
        ...
        self.assertTrue(any("negative sentiment" in factor for factor in factors))
    ...
    def test_redis_storage(self, mock_redis_class):
        ...
        self.assertTrue(mock_redis.ltrim.called)
