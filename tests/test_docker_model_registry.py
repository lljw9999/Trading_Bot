...
class TestDockerBuildIntegration(unittest.TestCase):
    ...
    def test_docker_requirements_file(self):
        ...
        self.assertTrue(requirements_path.exists(), "requirements-docker.txt should exist")
...
if __name__ == '__main__':
    ...
    # Add test cases
    suite.addTest(unittest.TestLoader().loadTestsFromTestCase(TestDockerBuildIntegration))
